...
const USER_SERVICE_URL = process.env.USER_SERVICE_URL || 'http://localhost:8080/api/users';
const BOOK_SERVICE_URL = process.env.BOOK_SERVICE_URL || 'http://localhost:8080/api/books';
